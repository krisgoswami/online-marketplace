            ...
            <div className="lg:flex-1 flex items-center justify-center p-12">
                <form className="max-w-md w-full space-y-4">
                    ...
                    <p className="text-center">
                        ...
                        <span>
                            {authState === "login" ? (
                                <a className='ml-1 hover:underline cursor-pointer text-teal-700' onClick={toggleAuthState}>Sign Up</a>
                            ) : (
                                <a className='ml-1 hover:underline cursor-pointer text-teal-700' onClick={toggleAuthState}>Login</a>
                            )}
                        </span>
                    </p>
                </form>
